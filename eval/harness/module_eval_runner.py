...
CRATES = [
  ...
  ("zaion-ledger",     "LED-001", "Event Non-repudiation",    2, "cargo test -p zaion-ledger --quiet"),
  ...
  ("zaion-aci",        "ACI-001", "Code Change Safety",       2, "cargo test -p zaion-aci --quiet"),
  ("zaion-evolve",     "EVO-001", "Net Evolution Gain",       2, "cargo test -p zaion-evolve --quiet"),
  ("zaion-autonomic",  "AUT-001", "Reflex Response",          1, "cargo test -p zaion-autonomic --quiet"),
  ("zaion-proprioception","PRP-001","Self-state Awareness",   1, "cargo test -p zaion-proprioception --quiet"),
  ("zaion-metabolic",  "MET-001", "Resource-aware Decision",  1, "cargo test -p zaion-metabolic --quiet"),
  ("zaion-curiosity",  "CUR-001", "Exploration ROI",          1, "cargo test -p zaion-curiosity --quiet"),
  ("zaion-ego",        "EGO-001", "Identity Continuity",      1, "cargo test -p zaion-ego --quiet"),
  ("zaion-singularity","SNG-001", "Autonomy Coordination",    1, "cargo test -p zaion-singularity --quiet"),
  ("zaion-shadow",     "SHD-001", "Parallel Strategy Value",  2, "cargo test -p zaion-shadow --quiet"),
  ("zaion-watchdog",   "WDG-001", "Fault Detect & Heal",      2, "cargo test -p zaion-watchdog --quiet"),
  ...
  ("zaion-telemetry",  "TEL-001", "Observability Completeness",1, "cargo test -p zaion-telemetry --quiet"),
  ("zaion-contract-macros","CM-001","Contract Enforcement",   1, "cargo test -p zaion-contract-macros --quiet"),
  ("zaion-proptest",   "PRP-001", "Property Discovery",       1, "cargo test -p zaion-proptest --quiet"),
]
