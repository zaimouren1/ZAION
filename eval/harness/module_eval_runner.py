...
CRATES = [
  ...
  ("zaion-core",       "CORE-001","Process Lifecycle",        3, "cargo test -p zaion-core --quiet"),
  ...
  ("zaion-crypto",     "CRY-001", "Crypto Correctness",       3, "cargo test -p zaion-crypto --quiet"),
  ("zaion-secrets",    "SEC-001", "Secret Lifecycle",         3, "cargo test -p zaion-secrets --quiet"),
  ("zaion-enclave",    "ENC-001", "Seal/Unseal Integrity",    3, "cargo test -p zaion-enclave --quiet"),
  ...
  ("zaion-federation", "FED-001", "Distributed Consistency",  3, "cargo test -p zaion-federation --quiet"),
  ...
  ("zaion-a2a",        "A2A-001", "Agent Interop",            3, "cargo test -p zaion-a2a --quiet"),
  ...
  ("zaion-evolve",     "EVO-001", "Net Evolution Gain",       3, "cargo test -p zaion-evolve --quiet"),
  ...
  ("zaion-shadow",     "SHD-001", "Parallel Strategy Value",  3, "cargo test -p zaion-shadow --quiet"),
  ("zaion-watchdog",   "WDG-001", "Fault Detect & Heal",      3, "cargo test -p zaion-watchdog --quiet"),
  ("zaion-opd",        "OPD-001", "Distillation Fidelity",    3, "cargo test -p zaion-opd --quiet"),
  ...
  ("zaion-contract-macros","CM-001","Contract Enforcement",   3, "cargo test -p zaion-contract-macros --quiet"),
